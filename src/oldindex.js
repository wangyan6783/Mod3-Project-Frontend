  ...
  function dropBomb(col, row, power) {
    ...
    fireGrids.map(fireGrid => {
      setTimeout(() => {
        ...
        if (fireArr.some(fireArr => fireArr[0] === currentLocation1[0] && fireArr[1] === currentLocation1[1]) && gameoverStatus === false) {
          gameoverStatus = true;
          let currentGridId1 = getGridId(currentLocation1[0], currentLocation1[1]);
          let currentGrid1 = getGridElement(currentGridId1);
        ...
        if (fireArr.some(fireArr => fireArr[0] === currentLocation2[0] && fireArr[1] === currentLocation2[1]) && gameoverStatus === false) {
          gameoverStatus = true;
          let currentGridId2 = getGridId(currentLocation2[0], currentLocation2[1]);
          let currentGrid2 = getGridElement(currentGridId2);
